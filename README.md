...
- Auth - local preview shell, ready for a production provider
...
- Local account and profile preview shell
- Multi-tenant workspace UI for creating, switching, and managing teams
- Billing and plan UI with local organization-level plan gating
...
| Page                                                                                                                                                                  | Notes                                                                                                                                                                                |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Signup / Signin                                                                                                                                                       | Local preview forms. Wire a production auth provider when needed.                                                                                                                   |
...
| [Profile](https://shadcn-dashboard.kiranism.dev/dashboard/profile)                                                                                                   | Local profile and security settings shell.                                                                                                                                          |
...
| [Workspaces](https://shadcn-dashboard.kiranism.dev/dashboard/workspaces)                                                                                              | Local organization management. View, create, and switch between organizations.                                                                                                      |
| [Team Management](https://shadcn-dashboard.kiranism.dev/dashboard/workspaces/team)                                                                                    | Team management UI for members, roles, permissions, security, and org details. Needs an active organization.                                                                        |
| [Billing & Plans](https://shadcn-dashboard.kiranism.dev/dashboard/billing)                                                                                            | Local billing and plan cards. Needs an active organization.                                                                                                                         |
| [Exclusive Page](https://shadcn-dashboard.kiranism.dev/dashboard/exclusive)                                                                                           | Local plan-based access control. Only available to organizations on the Pro or Team plan, with a fallback UI for everyone else.                                                     |
...
See `env.example.txt` for the variables you need. They cover build output and error tracking.
...
The upstream cleanup helper has been removed from this local copy so the organization and profile
design shells stay intact.
