...
export const pricingPlans = [
  ...
  },
  {
    ...
    overage: '초과 1회당 ₩1 과금',
    features: ['찰나의 모든 기능', '위젯', '샵 플레이어', '비디오 · 커머스 통계']
  },
  {
    name: 'Enterprise',
    tag: '맞춤',
...
export const guideFaqs: GuideFaq[] = [
  {
    id: 'smartstore',
    question: '네이버 스마트 스토어에서 찰나를 사용할 수 있나요?',
    answer:
      '네, 가능합니다. HTML5 Video Tag를 사용하여 찰나의 숏폼 영상을 네이버 스마트 스토어에서 활용할 수 있습니다.',
    steps: [
      '찰나의 코드 복사 탭에서 Video Tag 체크 박스를 선택합니다.',
      'HTML5 Video Tag 코드를 복사합니다.',
      '네이버 스마트 스토어의 HTML 직접 입력 영역에 복사한 코드를 붙여 넣습니다.'
    ],
    note: '따라하기 어려우면 찰나 사이트 좌측 하단 채팅으로 문의할 수 있습니다.'
  },
  {
    id: 'upload',
    question: '찰나의 동영상 업로드 가능 숫자는 누적인가요? 월별인가요?',
    answer: '동영상 업로드 가능 숫자는 누적입니다.'
  },
  {
    id: 'examples',
    question: '찰나를 활용한 사이트 적용 사례들에는 뭐가 있을까요?',
    answer:
      '찰나를 활용한 대표적인 사례는 동영상 배너, 랜딩페이지 대문, 상품 썸네일, 샵플레이어 재생목록입니다.',
    bullets: [
      '동영상 배너: 젝시믹스',
      '랜딩페이지 대문: 화미사',
      '상품 썸네일: 라이다',
  ...
  {
    id: 'price-policy',
    question: '찰나의 가격 정책은 어떻게 되나요?',
    answer:
      '찰나의 가격 정책은 고객사의 필요와 사용량에 따라 다르게 책정됩니다. 상세한 가격 정보는 가격 안내 페이지에서 확인하거나 고객 지원팀에 문의하면 맞춤형 견적을 받을 수 있습니다.'
  },
  {
    id: 'production',
    question: '찰나는 숏폼 제작업체인가요?',
    answer:
      '찰나는 숏폼 콘텐츠를 직접 제작하는 업체는 아니지만, 여러 숏폼 제작 업체와 제휴 협력이 되어 있어 필요한 경우 추가 지원을 제공할 수 있습니다.'
  },
  {
    id: 'multi-store',
    question: '찰나는 1개의 아이디로 여러 개의 사이트를 동시에 운영할 수 있나요?',
  ...
  {
    id: 'trial',
    question: '찰나를 무료로 체험해 볼 수 있나요?',
    answer: '네! 찰나는 한 달 동안 스탠다드 플랜으로 무료체험을 제공합니다.',
    bullets: [
      '카페24 사용 고객은 앱 스토어에서 찰나를 설치합니다.',
      '다른 플랫폼 고객은 찰나 소개페이지에서 무료로 시작하기 버튼을 누릅니다.'
    ]
  },
  {
    id: 'overage',
  ...
  {
    id: 'billing',
    question: '찰나 플랜은 어떻게 결제 되나요?',
    answer:
      '끊기지 않고 찰나를 사용할 수 있도록 회원가입 시 자동 결제 정보를 요청합니다. 무료체험 종료 후 Standard 플랜으로 구독이 자동 연장되며, 등록한 자동 결제 정보로 결제가 진행됩니다.',
